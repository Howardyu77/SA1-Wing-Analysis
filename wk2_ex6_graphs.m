...
if ils~=0
    if its~=0
        ...
        hold on
        plot(x(ils),theta(ils),'*','LineWidth',1,'MarkerSize',8);
        plot(x(itr),theta(itr),'o','LineWidth',1,'MarkerSize',8);
        plot(x(its),theta(its),'+','LineWidth',1,'MarkerSize',8);
        hold off
        xlabel('x/L')
        ylabel('\theta/L')
        title('Non-dimensionalised momentum thickness plot')
        legend({'Laminar separation','Turbulent separation'},'Location','Best','FontSize',9);

        figure(2)
        plot(x,He,'LineWidth',2,'HandleVisibility','off');
        hold on
        plot(x(ils),He(ils),'*','LineWidth',1,'MarkerSize',8);
        plot(x(itr),He(itr),'o','LineWidth',1,'MarkerSize',8);
        plot(x(its),He(its),'+','LineWidth',1,'MarkerSize',8);
        hold off
        xlabel('x/L')
        ylabel('H_e/L')
        title('Energy shape factor plot')
        legend({'Laminar separation','Turbulent reattachment','Turbulent separation'},'Location','Best','FontSize',9);
    else
        plot(x,theta,'LineWidth',2,'HandleVisibility','off');
        hold on
        plot(x(ils),theta(ils),'*','LineWidth',1,'MarkerSize',8);
        ...
        ylabel('\theta/L')
        title('Non-dimensionalised momentum thickness plot')
        legend({'Laminar separation','Turbulent reattachment'},'Location','Best','FontSize',9);
    ...
    if its~=0
        plot(x,theta,'LineWidth',2,'HandleVisibility','off');
        hold on
        plot(x(int),theta(int),'x','LineWidth',1,'MarkerSize',8);
        plot(x(its),theta(its),'+','LineWidth',1,'MarkerSize',8);
        hold off
        xlabel('x/L')
        ylabel('\theta/L')
        title('Non-dimensionalised momentum thickness plot')
        legend({'Natural transition','Turbulent separation'},'Location','Best','FontSize',9);

        figure(2)
        plot(x,He,'LineWidth',2,'HandleVisibility','off');
        hold on
        plot(x(int),He(int),'x','LineWidth',1,'MarkerSize',8);
        plot(x(its),He(its),'+','LineWidth',1,'MarkerSize',8);
        hold off
        xlabel('x/L')
        ylabel('H_e/L')
        ...
        ylabel('\theta/L')
        title('Non-dimensionalised momentum thickness plot')
        legend({'Natural transition'},'Location','Best','FontSize',9);
